							...
							<div class="col-xs-12">
								<div class="carousel-single gallery-product">
									...
									@else
										<div class="item item-carousel">
											<a href="{{ $data['product']['data']['data'][0]['image_lg'] }}" data-standard="{{ $data['product']['data']['data'][0]['image_lg'] }}">
												<img class="img img-responsive canvasSource" src="{{ isset($data['product']['data']['data'][0]['image_lg']) ? $data['product']['data']['data'][0]['image_lg'] : '' }}" alt="" style="width:100%;">
											</a>
										</div>									
									@endif
								</div>
